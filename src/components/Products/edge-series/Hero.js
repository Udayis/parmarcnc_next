...
const Hero = () => {
  return (
    <div className='cnc_hero_section'>
      <div className="cnc_hero_image_wrapper mobile-image-below">
        <Image
          id='cnc_logo_img'
      ...
      <div className='cnc_text_section'>
        <div className='cnc_description'>
          <p id='CNC_label_text'>CNC PRESS BRAKE MACHINE EDGE SERIES</p>
          <p id='CNC_sub_label_text'>Capacity : 40 Ton x 1000mm to 400 Ton x 4000mm</p>
        </div>

const cybelecMachines = [
  [
    {
      name: "DA- 53 T",
      image: "/images/ps8.png",
      features: [
  ...
  [
    {
      ...
      features: [
        ...
        'Delem Modusys application suite (module scalability and adaptivity)',
        'USB, peripheral interfacing',
...
export default cybelecMachines; 